...
def _gate_sudowrite_absorption_g72_2() -> dict:
    """Gate G72-2: Sudowrite 경쟁 흡수 + IP 자문 검증 (SP-C.4, ADR-130, C-M-11)."""
    try:
        ...
        return {
            "gate": "G72-2",
            "gate_name": "Sudowrite AbsorptionGate SP-C.4 (ADR-130, C-M-11)",
            "pass":    sub.passed,
            "passed":  sub.passed,
            "passed_count": 1 if sub.passed else 0,
            "total_count": 1,
            ...
            "errors": [] if sub.passed else ["G72-2 Sudowrite IP 미클리어 또는 리포트 FAIL"],
        }
    except Exception as exc:
        return {
            "gate": "G72-2",
            "gate_name": "Sudowrite AbsorptionGate SP-C.4 (ADR-130)",
            "pass":    False,
            "passed":  False,
            "passed_count": 0,
            "total_count": 1,
