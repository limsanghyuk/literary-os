...
for s in scenes:
    ...
    if not lines or lines[0] in speakers or re.fullmatch(r"[가-힣A-Za-z0-9 ()]+", lines[0]) and lines[0] in speakers: stage_fail.append(s["scene"])
...
result={
 "schema":"R77_H1_PA6_TREATMENT_R1_MECHANICAL_RESULT_R2_VALIDATOR",
 "date":"2026-09-25",
...
(out/"R77_H1_PA6_TREATMENT_R1_MECHANICAL_RESULT_R2.json").write_text(json.dumps(result,ensure_ascii=False,indent=2),encoding="utf-8")
