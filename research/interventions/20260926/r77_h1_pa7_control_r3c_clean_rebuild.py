...
res={"schema":"R77_H1_PA7_CONTROL_R3C_MECHANICAL_RESULT","date":"2026-09-26",
...
(D/"R77_H1_PA7_CONTROL_R3C_FULL_SCREENPLAY.txt").write_text(text,encoding="utf-8")
(D/"R77_H1_PA7_CONTROL_R3C_MECHANICAL_RESULT.json").write_text(json.dumps(res,ensure_ascii=False,indent=2),encoding="utf-8")
