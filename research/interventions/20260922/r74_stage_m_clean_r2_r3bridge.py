...
BRIDGE=ROOT/"research/interventions/20260922/r74_symmetric_semantic_measurement_bridge_r3.py"
...
result={
 "schema":"R74_STAGE_M_CLEAN_RESULT_R2_R3_BRIDGE",
...
pathlib.Path("r74_stage_m_clean_result_r3.json").write_text(json.dumps(result,ensure_ascii=False,indent=2))
