# EXT6 V1.2 Phase02 DesignSeed Single Authority V1.0.2

- Authority ID: `EXT6-V1.2-PHASE02-DESIGNSEED-AUTHORITY-V1.0.2`
- Status: **AUTHORIZED_PILOT_ONLY_CORRECTED**
- Date: 2026-08-01
- Supersedes for active execution: `V1.0.1`
...
V1.0 correctly defined the sidecar separation, blind-before-full order, evidence boundaries, and no-canonical-promotion policy. V1.0.2 corrects only derivation, admissibility, and executable gate semantics identified by the two-work independent review.
...
## V1.0.2 gate correction

9. Proper-name leakage excludes enumerated generic role labels; role nouns are not work-specific names.
10. RelationshipArc character labels are resolved through EntityBridge canonical names and aliases before opposition persistence aggregation. Exact raw-string equality is prohibited.
11. Alias collisions and unresolved relation labels are reported in gate counts; center-pair coverage uses only unambiguous resolved records.
