...
> ⚠️ **[2026-08-06 전제 정정]** 본 문서 §0의 "8B 단독으론 못 한다"는 **당시 가용 모델 제약에 근거한 우회책**이다. 확증 트랙 CT-01~03이 프론티어(Sonnet)로 렌더되었고 CT-03에서 작법 점수가 원본을 상회(+0.108)하여 **그 전제는 소멸**했다. 거시기획층의 결정론 배치를 본 문서 근거로 유지하지 말 것. → `DESIGN-MACRO-PLANNING-REANCHOR-v1.md`
