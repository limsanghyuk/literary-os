...
> ⚠️ **[2026-08-06 보강]** 사다리 좌표는 유효하나, 거시기획층(회차→시퀀스)은 **사다리 위의 한 칸이 아니라 축과 직교하는 미개척 층**임이 실측으로 드러났다(`sequence_planner.py` V325 산정식이 V795까지 약 470버전 무변경, 코드 주석의 "실측 기준"이 정본 실측과 약 2배 괴리). → `DESIGN-MACRO-PLANNING-REANCHOR-v1.md`
