...
SOURCE_COMMIT='fa85b8b119b466b833bb7ba383e0004035ae88ef'
FILES=[
'handoff/20260911/i4k5r4a_attempt2/treatment_superseding_r2/P07_I4K5R4A_ATTEMPT2_TREATMENT_SQ01_S01_05_R2_20260911.txt',
'handoff/20260911/i4k5r4a_attempt2/treatment_superseding_r3/P07_I4K5R4A_ATTEMPT2_TREATMENT_SQ02_S06_10_R3_20260911.txt',
...
r={'schema':'P07I4K5R4AAttempt2TreatmentMidpointR3MetricsR1','source_commit':SOURCE_COMMIT,'segments':segments,'body_chars_total':total,'body_chars_midpoint_min_18000_pass':total>=18000,'all_segments_min_3600_pass':all(x['body_chars']>=3600 for x in segments),'scene_ids':ids,'scene_ids_exact_1_25':ids==list(range(1,26)),'meta_leak_hits':meta,'meta_leak_zero':not meta,'CH_SQ_id_hits':iid,'CH_SQ_id_zero':not iid,'direct_emotion_pattern_hits':emo,'direct_emotion_pattern_zero':not emo,'exact_long_duplicate_lines':dups,'exact_long_duplicate_zero':not dups,'quality_inspection_performed':False}
...
Path('/tmp/i4k5r4a_attempt2_treatment_midpoint_r3_metrics.json').write_text(json.dumps(r,ensure_ascii=False,indent=2),encoding='utf-8')
