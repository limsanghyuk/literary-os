...
TREATMENT=json.loads(Path('handoff/20260911/P07_I4K5R4A_ATTEMPT2_TREATMENT_CANONICAL_MANIFEST_R3_20260911.json').read_text(encoding='utf-8'))['canonical_segments']
...
r={'schema':'P07I4K5R4AAttempt2PairedMechanicalPrescoreR3','control':c,'treatment':t,'relative_gap':gap,'control_min_35000_pass':c['body_chars_total']>=35000,'treatment_min_35000_pass':t['body_chars_total']>=35000,'relative_gap_max_0_10_pass':gap<=0.10,'quality_inspection_performed':False}
...
Path('/tmp/i4k5r4a_attempt2_paired_mechanical_prescore_r3.json').write_text(json.dumps(r,ensure_ascii=False,indent=2),encoding='utf-8')
