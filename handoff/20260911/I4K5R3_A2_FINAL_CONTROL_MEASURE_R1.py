...
import json,re
root=Path('handoff/20260911/i4k5r3_attempt2/control_final')
files=sorted(root.glob('P07_I4K5R3_A2F_CONTROL_SQ*_SC*.txt'))
rows=[]; total=0; ids=[]
for p in files:
...
Path('_i4k5r3_a2fc').mkdir(exist_ok=True)
Path('_i4k5r3_a2fc/metrics.json').write_text(json.dumps(out,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
