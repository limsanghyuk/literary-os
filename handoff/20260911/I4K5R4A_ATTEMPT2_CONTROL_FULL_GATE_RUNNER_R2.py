...
SOURCE_COMMIT='70ec77a33082428b3c2f20ba0b7fee0d220cbbb2'
FILES=[
...
r={'schema':'P07I4K5R4AAttempt2ControlFullGateMetricsR2','source_commit':SOURCE_COMMIT,'segments':segments,'body_chars_total':total,'body_chars_min_35000_pass':total>=35000,'all_segments_min_3600_pass':all(x['body_chars']>=3600 for x in segments),'scene_ids':ids,'scene_ids_exact_1_50':ids==list(range(1,51)),'meta_leak_hits':meta,'meta_leak_zero':not meta,'CH_SQ_id_hits':iid,'CH_SQ_id_zero':not iid,'direct_emotion_pattern_hits':emo,'direct_emotion_pattern_zero':not emo,'exact_long_duplicate_lines':dups,'exact_long_duplicate_zero':not dups,'quality_inspection_performed':False}
...
Path('/tmp/i4k5r4a_attempt2_control_full_gate_r2_metrics.json').write_text(json.dumps(r,ensure_ascii=False,indent=2),encoding='utf-8')
