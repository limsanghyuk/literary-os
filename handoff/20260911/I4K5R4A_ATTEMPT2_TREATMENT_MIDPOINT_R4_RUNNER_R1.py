...
SOURCE_COMMIT='fd2aff66f005fc6ba5f2a9fd13aa207b9fb89bd7'
FILES=[
...
Path('/tmp/i4k5r4a_attempt2_treatment_midpoint_r4_metrics.json').write_text(json.dumps(r,ensure_ascii=False,indent=2),encoding='utf-8')
