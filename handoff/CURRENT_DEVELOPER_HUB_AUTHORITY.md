...
The previous physical 9-package hashes are listed only as PREVIOUS_PHYSICAL_BASELINE in the developer authority snapshot. Do not promote them to current repaired authority until the repaired bytes are physically rebuilt and audited.