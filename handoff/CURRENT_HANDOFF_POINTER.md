...
3. `handoff/20260910/START_HERE_P07_NEW_SESSION_MASTER_HANDOFF_R1_20260910.md` — detailed research lineage; R2 corrects one runtime-receipt metadata path.
4. `handoff/20260910/P07_FAILURE_INCIDENT_RESPONSE_PLAYBOOK_R1_20260910.md`
5. `handoff/20260910/P07_NEW_SESSION_RECOVERY_MANIFEST_R2_20260910.json`
6. `handoff/CURRENT_DEVELOPER_HUB_AUTHORITY.md`
7. `handoff/20260910/P07_I4I_R2_FRESH_REPLICATION_CLOSURE_AND_PHYSICAL_SYNC_R2_20260910.md`
8. `handoff/CURRENT_NEXT_RESEARCH_POINTER.md`
9. `handoff/CURRENT_SESSION_RECOVERY_POINTER.md`
10. `handoff/CURRENT_NEXT_RESEARCH_CANDIDATE.md`
11. `handoff/CURRENT_DATABASE_RESEARCH_POINTER.md`
12. `handoff/20260909/START_HERE_P07_I4H_RECOVERY_R3_PHYSICAL_AUTHORITY_R1.md`
...
- I4J J1 fresh validation: preregistered; fresh Plan/Control/Selector/Revision Pool/Arms/Scores all 0.
...
Do not infer package corruption. Do not create a fresh I4J Control or simulate missing runtime/provider receipts until minimal process + filesystem + memory/OOM + small archive preflight passes.

## EXACT RESUME POINT
When runtime is healthy: minimal process -> filesystem -> cgroup/OOM -> small archive read -> verify Sync R2 identities -> confirm I4J prereg -> freeze fresh plan with all runtime-required anchors -> Control seal -> unchanged R3 Selector -> revision pool -> ARM_0/50/100 -> masked score -> unblind -> post-258 regression -> package impact -> physically deliver every changed transport.

## STATUS TOKEN
`CURRENT_HANDOFF_MASTER_R2_WITH_STUDY_GUIDE__SYNC_R2_6E630BF4__ACTIVE_I4H_RECOVERY_R3__DB59_FROZEN__I4I_R1_FAIL__I4I_R2_FAIL__I4J_J0_COMPLETE__I4J_J1_OUTPUTS_0__MINIMAL_PROCESS_3_OF_3_TIMEOUT_BLOCK__PRODUCTION_R47__FORMAL_137__R140_0_0_0`
