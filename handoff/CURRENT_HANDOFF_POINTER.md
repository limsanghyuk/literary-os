...
- the recovered developer-delivered active-development physical authority is `CURRENT_PHYSICAL_AUTHORITY__P07_I4H_FAIL_CLOSED_RUNTIME_RECOVERY_R3`;
...
- the package authority is closed, but platform/tool execution transport remains an intermittent external operational risk; a fresh session must complete the mandatory runtime preflight before large-package analysis or new research.

Read order:
1. this pointer;
2. `handoff/20260909/START_HERE_P07_I4H_RECOVERY_R3_PHYSICAL_AUTHORITY_R1.md`;
3. `handoff/20260909/P07_POST_DELIVERY_RUNTIME_TRANSPORT_RECURRENCE_R1_20260909.md`;
4. `handoff/CURRENT_DEVELOPER_HUB_AUTHORITY.md`;
5. `handoff/CURRENT_SESSION_RECOVERY_POINTER.md`;
6. `handoff/20260909/P07_I4H_RECOVERY_QUALIFICATION_PREREG_R2_20260909.json`;
7. `handoff/20260909/P07_I4H_RECOVERY_QUALIFICATION_R2_PREREG_AMENDMENT_R1_TARGETED_TEST_DEFINITION_20260909.json`;
8. `handoff/20260908/START_HERE_P07_SYNC_R6_PHYSICAL_AUTHORITY_NEW_SESSION_HANDOFF_R1.md`.
